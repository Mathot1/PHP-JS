...
--
-- Host: 127.0.0.1
-- Czas generowania: 29 Pa≈∫ 2018, 16:52
...
-- Baza danych: `nowa`
--
CREATE DATABASE IF NOT EXISTS `nowa` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `nowa`;
...
(33, 'Willemstad', 'ANT', 'Cura√ßao', 2345),
...
(52, 'Gharda√Øa', 'DZA', 'Gharda√Øa', 89415),
...
(61, 'South Hill', 'AIA', '‚Äì', 961),
(62, 'The Valley', 'AIA', '‚Äì', 595),
...
(147, 'Ming√§√ßevir', 'AZE', 'Ming√§√ßevir', 93900),
...
(220, 'S√£o Gon√ßalo', 'BRA', 'Rio de Janeiro', 869254),
(221, 'Nova Igua√ßu', 'BRA', 'Rio de Janeiro', 862225),
...
(280, 'Foz do Igua√ßu', 'BRA', 'Paran√°', 259425),
...
(333, 'Ara√ßatuba', 'BRA', 'S√£o Paulo', 169303),
...
(351, 'Cama√ßari', 'BRA', 'Bahia', 149146),
...
(365, 'Po√ßos de Caldas', 'BRA', 'Minas Gerais', 129683),
...
(378, 'Moji-Gua√ßu', 'BRA', 'S√£o Paulo', 123782),
...
(388, 'Bragan√ßa Paulista', 'BRA', 'S√£o Paulo', 116929),
...
(444, 'S√£o Louren√ßo da Mata', 'BRA', 'Pernambuco', 91999),
...
(451, 'Palho√ßa', 'BRA', 'Santa Catarina', 89465),
(452, 'Barra do Pira√≠', 'BRA', 'Rio de Janeiro', 89388),
(453, 'Bento Gon√ßalves', 'BRA', 'Rio Grande do Sul', 89254),
(454, 'Po√°', 'BRA', 'S√£o Paulo', 89236),
(455, '√Åguas Lindas de Goi√°s', 'BRA', 'Goi√°s', 89200),
...
(648, 'Soyapango', 'SLV', 'San Sa$ä üæ6ÄZâŸ «9 ‚∂ëWL<ÏS˚íü–ü⁄r˛∞Dˆ É ' pé†Hi˛›ª¬ÀÅ≥qô¢§vQÒ…#{¨—ﬂ£G9	“Ââ˝6ƒ…E)`ãíêÇ•;bëm1KÄΩÕ¯kg¿ˆoıâÄ"^’˙·J3!æ‡‹^_ıèE·œΩ}@Àer%A4wVwﬂ(lﬂ°Vﬂ¡GGõP≥_’=^_wæ2◊—§˜tø›ò∆ÒÖTtd˛Cf—V$^- K∞Íµzp¶Œ·n›q^Ü-4™eìÿcÂ¸yº
W/'OÊÅ¶»-?O5à≠ô¬_≤§MSØLhi÷~à:ù´∆]6é’,∏ÿÇ‹êb<◊Ûu“òòñ˙ÛÌ–)÷œ–«b∞ë≥Çk…«ó◊xõ˛/ﬁÇL¥≈jíÏ√ºüVIµ"~c6fîQ´q¨Ø"Ê⁄„o| ôß¸K5(ÈxDëQ5Gfq≥Ùˆ$‡E•Õº∂rã∫ÉP∏ ã	Î!ÿâ…ÿFÙo≠¬L∂ıú€<∂p/…ŒVZ˜Ò—C1†®èÑDµ4›'â™|LW"0`ê’ô}Heçö∆q«õ¡cÎõáA¯và˙0«ùM¨8C+∞[€3[»í1÷mFí©µ‘Æ{ŸÏ@-∑∂øR9]yû±U}"öøßMvÄÜèëp}!ï0ƒÇNÔ:ZŸI‡Z1Ñ\¯ıL∫˘∂∞Cl%IJS‚xıaÜà<Êa4§°l§ßËB◊MQìlÖ!LZ¡¡ê∫€fíe∑	åÖPt3ò|/~.AÁt*x∏´rq,åë3UD°≠≈W›∏ê¡„ÃwI_$Qñouh»1≥ÒE0éïõò∫ˆ†¨#õJæ ÿëûŸn¯◊](˛ÕÃD∆m∏w°QÓ!ôÆÿFœ«f°Ã«·ªÖÖ∆SîÔ—wd’ÓÒ∑iMïƒÑç–ìençDWTéaTKı#ØïÈç∞òÄ
/jø¢†]¯(¿rLØÑ(,–>∑EñwK*Ç±ÆÉ|ÎÈ≈Äe∫(äÉ{ê*πHôÂK~#Óüu›G«™©Œï]¬Eæå˜êY∆|?Ÿ«êROÅX˚LjHg4ëìô^dÛÚã‚*è‡∑.)£^?„^´ÛûˇÆâBQ ◊!k.Ù{Y÷Ä‰Ô–M≤ã_öO'≥·U≥ÚÊàG≤5)ÌO…\¢x≠¬–Z–V;ò-Uî C2ÍlªD∞àS“x#”â£oI“ÎàΩ–ñ≠.∞&\≤Ì/
≠ö‚öÌüS∏?2kà«¨‘=˛G»l¯æ{uZCú°∫', 'ESP', 'Andalusia', 244767),
...
(814, 'Olongapo', 'PHL', 'Central Luzon#, 194260),
(811, 'Binangona.', 'PHL', 'Southern Tagalog',(187691),
(812, 'Sanda Rosa', 'PHL', 'Southern!Tagalng', 185633),
(813, 'TaguÌ', 'PJL', 'Southern0Mildanao', 579531),
(814, 'Tacloban', 'PHL',"#Easturn Vis!yas'$ 178639),
®<15<$'Malolos', '–HL', 'Central Luzon', 175291),
(16, 'Mabalacat', 'PHL', 'C%ntraL Luzon', 171045),
,807, 'Cotabato'$ 'PHL',0'Cantral Mindanao', 163849),
(818, 'Me{cauayan', 'PHL', 'Central Luzon', 163037),
(819, 'Puepto"Princesa&, 'PHL', 'Southern Tagalog', 161912),
(820, 'Legazpi', 'PHL', 'Bicol',!157010),
(821, 'Silang', 'PHL', 'Southern Tagalog', 156137),
(822,$'Ormoc', 'PHL', 'EAstern Visayas/,†154297),
(823, 'San Carlos', 'PHL', 'Ilocs', 154264),
(834, 'KAbankalan', 'PHL' 'We{tern Visayas', 149769),
(825, 'Talisay', 'PHL', 'Central Visayas', 148110),
(826, 'Valencia', PHL', 'Northern Mindafao', 147926),
(827, 'Calbayog', 'PHL', 'Eqstern Visayas', 147107),
(828, 'San4a Maria'( 'PHL', 'Centran Luzon', 144282),
(829, 'Pagadyan', 'PHL', 'Western Mindanao', 142515),
...
(910, 'Accra', 'GHA%, 'Greater Accra',  70000),
(911, ßKumasi', 'GHA', 'Ashanti', 385192),
(912, 'Tamale', 'GHA', 'Oorthurng, 151069),
(913, 'Teoa', 'GHC', 'Greaper Accra', 109975),
(914, 'Sekondi-Takoradi', 'GHA', 'Western',`103653),
(915, 'Gibraltar', GIB', '‚Äì', 2702=),
(916, 'Saint «eorgeBîs', 'GRD', 'St Geopge', 46≤0),
(917, 'Nuuk', 'GRL', 'Kitaa', 13445),
(918, 'Les Abymes', 'GLP' 'Gsande-Terr%ß, 62947),
)919, 'Basse-Tmrre', 'GLP', 'Basse-Terre', 12433),
(920,('Tamuning', 'GUM', '‚Äì', 9500),
(1828, 'Kitchener', 'CAN', 'Ontario', 189959),
(1∏29, 'Markham', 'CAN', 'Ontarik', 189098),
 1830, 'Regina', 'CAN', 'Saskatchewan', 100400),
(1831, 'BurNaby', 'CAN/, 'British Colombia', 179209),
(1832, 'Qu√©bec', 'CAN', 'Qu√©bes',!167264),
(1833, 'York', 'CANg, 'Ontario'l 1549x0),
(1834, 'Sichmond', 'CAN', 'BRitish Colombia', 148867).
(1835, 'Vawghan', 'CAN', 'Ontario', 17889),(18;6, 'Burlingvonß, 'CAN', 'Ontario'< 145150),
(183, 'Oshawa',!'CAN',"'ontario', 140173),
(1838, 'Oakville, /CAN', 'Ontario', 1391=2),
(18≥9, 'Saint Catharines'$ 'CAN'< 'Ontario', 136016)<
(1840, 'Longueuil, &CAN', /Qu√©bec', 127977),
(1841, 'Richmond Hill', 'SAN', 'Ontario', 116428),
(1842, 'Thunder @ay', 'CAN', 'Ontario', 115913),
(1843, 'Nerean', CAN', 'Ontario', 115100),
¨18$4, 'Cape Breton', 'CAN', 'Nova Qcotia', 114733)(
(1845, 'East York'- 'CAN', 'Ontario', 114034)
(1846, #Halifax', 'CAN', 'Nova"Scotia', 11;910!,
(1847, 'Cambridge', 'CAN', 'Ontario', 1091(6),
(1848, 'Gloucester', 'CAN', 'ntario', 107314),
(1849, 'Abbopsford', 'CAN', 'British Col/mbia', 105403),
(1850, 'Guelph', 'CAN', 'Ontario', 103593),
(1851, 'Saint John¬¥s', 'CAN', 'Jewfoundland', 10193v),
(1852, 'Coquitlam', 'CAN', 'Br}tish Cglombia', 101820),
(1853, 'Saanich', 'CAN', 'Britiqh Colombia', 101388),
(185∑, 'Gatineau', 'CAN', 'Qu√©bec'< 10070:),
(18%5, 'Delta', 'CAN', 'ritis` Colombia', 95411),
(1856,!'Sudbury',`'CAN', 'Ontario', 92686),
(1857. 'K%lovna', 'CAN', 'British Colombia', 89442),
(1858, 'BaRrie',0'CAN/, 'Ontario', 89269),
(1859, 'Praia'< 'CPF', 'S√≥o Tiago',(94800),
(1860, 'Almaty', 'KAZ', 'Ammaty Qalasy', 1129410),
(1861, Qaragha~dy', 'KAZ', 'Qaraghandy'l 436900),
(1862, 'Shymkent', 'KAZ', 'South KazaksTan',`360100),
(18∂3- 'Taraz', 'KAZ#, 'Tcraz', 330100),
(1864, '¡stana', 'KAZ', 'Astan!', 311200),
(1865,!'√îskemmn', 'KAZ', 'East Kazakstan', 311000),
(1866, 'Pavlodar'¨ ßKAZ', 'Pavlodar', 300500),
...
(1917, 'Urumt≈°i [√úr√ºmqi]', 'CHN', 'Xinxiang', 1310100),
...
(2277, 'Itag√º√≠', 'COL', 'Antioquia', 228985),
...
(2302, 'Kisangani', 'COD', 'Haute-Za√Øre', 417517),
...
(2415, 'Camag√ºey', 'CUB', 'Camag√ºey', 298726),
...
(2426, 'Ciego de √Åvila', 'CUB', 'Ciego de √Åvila', 98505),
...
(2541, 'Centro (ËÊ<≥Ø{lå"»¸≥&èCGá∂a¿$»vÃÀúeØj6˜≥Xs¨X^L…ÄnLÉrıòÕ•;¿ëÓ}“c#kÎâvçªAC m}ållZπ¸íß≈·
(3070, 'Munich [M√ºnchen]', 'DEU', 'Baijeri', 1194560),
...
(3075, 'Stuttgart', 'DEU', 'Baden-W√ºrttemberg', 582443),
(3076, 'D√ºsseldorf', 'DEU', 'Nordrhein-Westfalen', 568855),
...
(3081, 'N√ºrnberg', 'DEU', 'Baijeri', 486628),
...
(3086, 'Mannheim', 'DEU', 'Baden-W√ºrttemberg', 307730),
(3087, 'Bonn', 'DEU', 'Nordrhein-Westfalen', 301048),
(3088, 'Gelsenkirchen', 'DEU', 'Nordrhein-Westfalen', 281979),
(3089, 'Karlsruhe', 'DEU', 'Baden-W√ºrttemberg', 277204),
(3090, 'Wiesbaden', 'DEU', 'Hessen', 268716),
(3091, 'M√ºnster', 'DEU', 'Nordrhein-Westfalen', 264670),
...
(3131, 'Heilbronn', 'DEU', 'Baden-W√ºrttemberg', 119526),
(3132, 'Pforzheim', 'DEU', 'Baden-W√ºrttemberg', 117227),
(3133, 'Offenbach am Main', 'DEU', 'Hessen', 116627),
(3134, 'Ulm', 'DEU', 'Baden-W√ºrttemberg', 116103),
(3135, 'Ingolstadt', 'DEU', 'Baijeri', 114826),
(3136, 'Gera', 'DEU', 'Th√ºringen', 114718),
(3137, 'Salzgitter', 'DEU', 'Niedersachsen', 112934),
(3138, 'Cottbus', 'DEU', 'Brandenburg', 110894),
(3139, 'Reutlingen', 'DEU', 'Baden-W√ºrttemberg', 110343),
(3140, 'F√ºrth', 'DEU', 'Baijeri', 109771),
...
(3152, 'Jena', 'DEU', 'Th√ºringen', 99779),
(3153, 'Iserlohn', 'DEU', 'Nordrhein-Westfalen', 99474),
(3154, 'G√ºtersloh', 'DEU', 'Nordrhein-Westfalen', 95028),
(3155, 'Marl', 'DEU', 'Nordrhein-Westfalen', 93735),
(3156, 'L√ºnen', 'DEU', 'Nordrhein-Westfalen', 92044),
(3157, 'D√ºren', 'DEU', 'Nordrhein-Westfalen', 91092),
(3158, 'Ratingen', 'DEU', 'Nordrhein-Westfalen', 90951),
(3159, 'Velbert', 'DEU', 'Nordrhein-Westfalen', 89881),
(3160, 'Esslingen am Neckar', 'DEU', 'Baden-W√ºrttemberg', 89667),
...
(3208, 'Singapore', 'SGP', '‚Äì', 4017733),
(3209, 'Bratislava', 'SVK', 'Bratislava', 448292),
(3210, 'Ko≈°ice', 'SVK', 'V√Ωchodn√© Slovensko', 241874),
(3211, 'Pre≈°ov', 'SVK', 'V√Ωchodn√© Slovensko', 93977),
...
(3240, 'Turku [√Öbo]', 'FIN', 'Varsinais-Suomi', 172561),
...
(3245, 'Z√ºrich', 'CHE', 'Z√ºrich', 336800),
...
(3346, 'Hradec Kr√°lov√©', 'CZE', 'V√Ωchodn√≠ Cechy', 98080),
(3347, '√öst√≠ nad Labem', 'CZE', 'Severn√≠ Cechy', 95491),
(3348, 'Pardubice', 'CZE', 'V√Ωchodn√≠ Cechy', 91309),
...
(3364, 'Mersin (I√ßel)', 'TUR', 'I√ßel', 587212),
...
(3388, '√áorum', 'TUR', '√áorum', 145495),
(3389, 'K√ºtahya', 'TUR', 'K√ºtahya', 144761),
...
(3398, '√áorlu', 'TUR', 'Tekirdag', 123300),
', 'Nonmetropolitan Territory of France', 'Jacques Chirac', NULL, 'TF'),
...
('AUT', 'Austria', 'Europe', 'Western Europe', 83859.00, 1918, 8091800, 77.7, 211860.00, 206025.00, '√ñsterreich', 'Federal Republic', 'Thomas Klestil', 1523, 'AT'),
('AZE', 'Azerbaijan', 'Asia', 'Middle East', 86600.00, 1991, 7734000, 62.9, 4127.00, 4100.00, 'Az√§rbaycan', 'Federal Republic', 'Heyd√§r √Ñliyev', 144, 'AZ'),
...
('CAF', 'Central African Republic', 'Africa', 'Central Africa', 622984.00, 1960, 3615000, 44.0, 1054.00, 993.00, 'Centrafrique/B√™-Afr√Æka', 'Republic', 'Ange-F√©lix Patass√©', 1889, 'CF'),
...
('CIV', 'C√¥te d‚ÄôIvoire', 'Africa', 'Western Africa', 322463.00, 1960, 14786000, 45.2, 11345.00, 10285.00, 'C√¥te d‚ÄôIvoire', 'Republic', 'Laurent Gbagbo', 2814, 'CI'),
...
('CRI', 'Costa Rica', 'North America', 'Central America', 51100.00, 1821, 4023000, 75.8, 10226.00, 9757.00, 'Costa Rica', 'Republic', 'Miguel √Ångel Rodr√≠guez Echeverr√≠a', 584, 'CR'),
...
('CYP', 'Cyprus', 'Asia', 'Middle East', 9251.00, 1960, 754700, 76.7, 9333.00, 8246.00, 'K√Ωpros/Kibris', 'Republic', 'Glafkos Klerides', 2430, 'CY'),
...
('DZA', 'Algeria', 'Africa', 'Northern Africa', 2381741.00, 1962, 31471000, 69.7, 49982.00, 46966.00, 'Al-Jaza‚Äôir/Alg√©rie', 'Republic', 'Abdelaziz Bouteflika', 35, 'DZ'),
...
('GUF', 'French Guiana', 'South America', 'South America', 90000.00, NULL, 181000, 76.1, 681.00, NULL, 'Guyane fran√ßaise', 'Overseas Department of France', 'Jacques Chirac', 3014, 'GF'),
...
('HTI', 'Haiti', 'North America', 'Caribbean', 27750.00, 1804, 8222000, 49.2, 3459.00, 3107.00, 'Ha√Øti/Dayti', 'Republic', 'Jean-Bertrand Aristide', 929, 'HT'),
...
('IRL', 'Ireland', 'Europe', 'British Islands', 70273.00, 1921, 3775100, 76.8, 75921.00, 73132.00, 'Ireland/√âire', 'Republic', 'Mary McAleese', 1447, 'IE'),
...
('ISL', 'Iceland', 'Europe', 'Nordic Countries', 103000.00, 1944, 279000, 79.4, 8255.00, 7474.00, '√çsland', 'Republic', '√ìlafur Ragnar Gr√≠msson', 1449, 'IS'),
('ISR', 'Israel', 'Asia', 'Middle East', 21056.00, 1948, 6217000, 78.6, 97477.00, 98577.00, 'Yisra‚Äôel/Isra‚Äôil', 'Republic', 'Moshe Katzav', 1450, 'IL'),
...
('KOR', 'South Korea', 'Asia', 'Eastern Asia', 99434.00, 1948, 46844000, 74.4, 320749.00, 442544.00, 'Taehan Min‚Äôguk (Namhan)', 'Republic', 'Kim Dae-jung', 2331, 'KR'),
...
('LBN', 'Lebanon', 'Asia', 'Middle East', 10400.00, 1941, 3282000, 71.3, 17121.00, 15129.00, 'Lubnan', 'Republic', '√âmile Lahoud', 2438, 'LB'),
...
('MOZ', 'Mozambique', 'Africa', 'Eastern Africa', 801590.00, 1975, 19680000, 37.5, 2891.00, 2711.00, 'Mo√ßambique', 'Republic', 'Joaqu√≠m A. Chissano', 2698, 'MZ'),
...
('PRY', 'Paraguay', 'South America', 'South America', 406752.00, 1811, 5496000, 73.7, 8444.00, 9555.00, 'Paraguay', 'Republic', 'Luis √Ångel Gonz√°lez Macchi', 2885, 'PY'),
...
('PYF', 'French Polynesia', 'Oceania', 'Polynesia', 4
...
CREATE TABLE `samochody` (
  ...
  `przebieg` decimal(10,2) DEFAULT NULL,
  `rok_produkcji` int(4) DEFAULT NULL,
  `predkosc_max` int(3) DEFAULT NULL,
...
INSERT INTO `samochody` (`numer`, `nr_rej`, `marka`, `model`, `kolor`, `przebieg`, `rok_produkcji`, `predkosc_max`, `stan`) VALUES
(1, 'PO4566', 'Seat', 'Ibiza', 'bia?y', '789.90', 2017, 200, 'OK'),
(2, NULL, 'Seat', 'Ibiza', 'bia?y', '789.90', 2017, 200, NULL);
...
-- Baza danych: `osoby2`
--
CREATE DATABASE IF NOT EXISTS `osoby2` DEFAULT CHARACTER SET utf8 COLLATE utf8_polish_ci;
USE `osoby2`;
...
CREATE TABLE `osoby` (
  `Numer` int(11) NOT NULL,
  `Imie` varchar(20) CHARACTER SET utf16 COLLATE utf16_polish_ci NOT NULL,
...
INSERT INTO `osoby` (`Numer`, `Imie`, `Nazwisko`, `Wiek`, `Miejscowosc`) VALUES
(2, 'B≈Ça≈ºej', 'P√≥≈Çka', 33, 'Zamo≈õƒá'),
(3, 'Marcin', 'Miƒôtus', 30, 'Pozna≈Ñ');
...
(1, 'root', 'server', 'szkola_nazwa', '{\"quick_or_custom\":\"quick\",\"what\":\"sql\",\"db_select[]\":[\"nowa\",\"osoby2\",\"phpmyadmin\",\"pracownicy\",\"przychodnia\",\"sklep\",\"sprawdzian\",\"szkola\",\"test\",\"weterynarz\"],\"aliases_new\":\"\",\"output_format\":\"sendit\",\"filename_template\":\"@SERVER@\",\"remember_template\":\"on\",\"charset\":\"utf-8\",\"compression\":\"none\",\"maxsize\":\"\",\"codegen_structure_or_data\":\"data\",\"codegen_format\":\"0\",\"csv_separator\":\",\",\"csv_enclosed\":\"\\\"\",\"csv_escaped\":\"\\\"\",\"csv_terminated\":\"AUTO\",\"csv_null\":\"NULL\",\"csv_structure_or_data\":\"data\",\"excel_null\":\"NULL\",\"excel_columns\":\"something\",\"excel_edition\":\"win\",\"excel_structure_or_data\":\"data\",\"json_structure_or_data\":\"data\",\"json_unicode\":\"something\",\"latex_caption\":\"something\",\"latex_structure_or_data\":\"structure_and_data\",\"latex_structure_caption\":\"Struktura tabeli @TABLE@\",\"latex_structure_continued_caption\":\"Struktura tabeli @TABLE@ (kontynuacja)\",\"latex_structure_label\":\"tab:@TABLE@-structure\",\"latex_relation\":\"something\",\"latex_comments\":\"something\",\"latex_mime\":\"something\",\"latex_columns\":\"something\",\"latex_data_caption\":\"Zawarto√Ö‚Ä∫√Ñ‚Ä° tabeli @TABLE@\",\"latex_data_continued_caption\":\"Zawarto√Ö‚Ä∫√Ñ‚Ä° tabeli @TABLE@ (kontynuacja)\",\"latex_data_label\":\"tab:@TABLE@-data\",\"latex_null\":\"\\\\textit{NULL}\",\"mediawiki_structure_or_data\":\"data\",\"mediawiki_caption\":\"something\",\"mediawiki_headers\":\"something\",\"htmlword_structure_or_data\":\"structure_and_data\",\"htmlword_null\":\"NULL\",\"ods_null\":\"NULL\",\"ods_structure_or_data\":\"data\",\"odt_structure_or_data\":\"structure_and_data\",\"odt_relation\":\"something\",\"odt_comments\":\"something\",\"odt_mime\":\"something\",\"odt_columns\":\"something\",\"odt_null\":\"NULL\",\"pdf_report_title\":\"\",\"pdf_structure_or_data\":\"data\",\"phparray_structure_or_data\":\"data\",\"sql_include_comments\":\"something\",\"sql_header_comment\":\"\",\"sql_use_transaction\":\"something\",\"sql_compatibility\":\"NONE\",\"sql_structure_or_data\":\"structure_and_data\",\"sql_create_table\":\"something\",\"sql_auto_increment\":\"something\",\"sql_create_view\":\"something\",\"sql_create_trigger\":\"something\",\"sql_backquotes\":\"something\",\"sql_type\":\"INSERT\",\"sql_insert_syntax\":\"both\",\"sql_max_query_size\":\"50000\",\"sql_hex_for_binary\":\"something\",\"sql_utc_time\":\"something\",\"texytext_structure_or_data\":\"structure_and_data\",\"texytext_null\":\"NULL\",\"yaml_structure_or_data\":\"data\",\"\":null,\"as_separate_files\":null,\"csv_removeCRLF\":null,\"csv_columns\":null,\"excel_removeCRLF\":null,\"json_pretty_print\":null,\"htmlword_columns\":null,\"ods_columns\":null,\"sql_dates\":null,\"sql_relation\":null,\"sql_mime\":null,\"sql_disable_fk\":null,\"sql_views_as_tables\":null,\"sql_metadata\":null,\"sql_drop_database\":null,\"sql_drop_table\":null,\"sql_if_not_exists\":null,\"sql_procedure_function\":null,\"sql_truncate\":null,\"sql_delayed\":null,\"sql_ignore\":null,\"texytext_columns\":null}');
...
('root', '[{\"db\":\"szkola\",\"table\":\"klasa\"},{\"db\":\"szkola\",\"table\":\"uczen\"},{\"db\":\"szkola\",\"table\":\"wychowawca\"},{\"db\":\"nowa\",\"table\":\"country\"},{\"db\":\"nowa\",\"table\":\"city\"},{\"db\":\"nowa\",\"table\":\"countrylanguage\"},{\"db\":\"nowa\",\"table\":\"samochody\"},{\"db\":\"pracownicy\",\"table\":\"pracusie\"},{\"db\":\"pracownicy\",\"table\":\"osoby\"},{\"db\":\"osoby2\",\"table\":\"osoby\"}]');
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='Saved searches'qà≥óÁ+—˛Å´8Øf\ıûÎëˇF|s©∞Qåˆ˘>V©Í·—‘`ƒlæY;ˆªÆk/ïØıÛô›íÔ'¡ëéÊ‘yÄë‡zˇB˝˜Ü≥™ò/\Èb°âc±íÛ‡; ¶r
≠á3/H/>∏∂ÁDû®¶è	‡óYoU|¥ıd—≈—{4Âû¡¡ÌWÅ¿ﬁÒ4fq!ç*Ekiû‘çÑ@ÍÔ4Ù€µ_>ﬁ?ƒHˆ;ûb9A)˘–±uUÊﬁ«¶gt£=U}uîŒâ·†âƒs®ÿØ¥0;¨"®q*∑	’ªdnæEüŸÂŒ!(;M∏Ì˘Iøt
ïY\'ö≈ 2ˇwV^f◊∞¨5ƒu`,ßœæüÁmg†öÇ6∂]öÂ9&E©s˘AûáZ}Pô«H˜ú)œv–ˇÌöKÕñJ∂@±÷s*{„YWXBUA 6:?Ö∑ê„P^ZnÖºé≥°ŒgÛ0´GÙ£Ûõ=eßCFçVy%_gŸ˘8t$‡üpËë¡Q9sáÊ	…‚NZ‚ÃuR|ìL];mâ{˛£ Y—¡ıóêw
éöÙ∑Àæ≠	¿Ω ñ‹.Ï∑‹ıC`4Ui¶¿3a¶–Ø{óS9•F¡ÍëŒÚ‡¨H]÷r„ÿò˘±>˚[ïˆ»®Ü∏2—(<ù
“≤1p™wBñv#±ç¨¶Jñpï¯Ã5ˆ∫å'ö ögq„r±ô±yäÑgïd_Ø˘Üˇ≈•hÚ’ÉıìÓµênkœdsr‹öΩt^5a«˜ï´€uÄ4ìΩmS4€Ñû2˝ƒUa<VÌ ∂£îŒ åºä(∞s{Ì‘XCÊ[åﬁd 	{ÉEZsK$HK‚ö§‘') 6Ö3è«£˚N≈ˆS÷™á$`ı‘¶¢æ>M;◊⁄RÕ}ÌqÉÿòçÑ¨;&≠]Ñ±ç¸@¢;Zp◊Uó37g˜ƒ?7	∏¿„´•±=<˚(¿gd∆õô¢†¨öºùö≠db ]íÇ$Î•üöÍÈF7XÒ·ç°xPyêNô»èJ*å6Kµ…]Ro π–”“˛*ïû∂\ÿi ≥∂3e4âÒj¬™—lÛ#5yëVú¿πîº[Ä\LK+tÈº Ó.=≈$ÈÉØÜV8≥”µó6˚ò°≥±˙êˇ«ÄXs<ó¡TB'&Á¨‘ãd‘ªcáêRÙàñ§°–Áx˘U)ÔŒ1+v€ÈˇˇõM2·mÕñGÅ˜ñØ E‰Wô;©Ç˚oŸ–`Wå“I4òöæJÕΩï” àQ8¶¸O3ïRby
-`Ÿz¡xõ¶%¨¿«Q’˜π!-------
...
('root', '2018-10-29 15:31:11', '{\"lang\":\"pl\",\"Console\\/Mode\":\"cgll!pse\"y');

-- --------------------------Ø----------------------m-----

-%
-- Struktura tabeli dla tabeli `pma__tsergroupS`
/-

CREATE UACLE `pma__usergroups` (
  `uSergroup` varchar(6) COLLATE utf8bin NOT NULÃ,
  `tab` varchar(64) COLLATE utf8_bin NOT NULL,
  `allowed` enum('I','N') COLLATE utf8_bin`NOT NULL DEFAUL 'N'
) ENGINE=InnoDB DEFAULT CHARSET=utf80COLTE=uuÊ8_bin GO]MENT='User groups with configuzed menu ipems';

-/ -----/-------------------------------------------------

--
-- Strukt5ra vabeli dla tabÂli `pma__users`
--

CREATE TABLE `pma__users` (
  `usarname` virciar(64) COLLATE upf8_bin NOT NULL,
  `uwergroup` varchar(64) COLLATE utf8_bin NOT NULL
) ENGINE=InnmDB DEFAULT CHARSET=utf8 COLLATE=utf8_bIn COMMENT='Users and their assignments to user groups';

--
--"Indeksy dla!zrzut√≥w tabeh
--

-
-- Indeksy dla tabe,i `pmaO_bogkmarj`
--
ALTER TABLe `pma__bookmark`
  ADD PRIMARY KE (`id`);

-/
-- Indeksy dla tabe,i `pmaﬂ_cejtsal_columnr`
--
ALTER TIBLE `pma__central_columns`
  ADd P“IMARY KEY (`db_name`,`col_name`);
...
--
-- Struktura tabeli dla tabeli `pracusie`
--

CREATE TABLE `pracusie` (
  `IDRek` int(2) NOT NULL,
  `Nazwisko` varchar(20) DEFAULT NULL,
  `Imie` varchar(20) DEFAULT NULL,
  `MiejUrodz` varchar(20) DEFAULT NULL,
  `Bank` varchar(20) DEFAULT NULL,
  `Pensja` decimal(8,2) DEFAULT NULL,
  `Lokata` decimal(7,2) DEFAULT NULL,
  `Wydzial` varchar(20) DEFAULT NULL,
  `Zainter` varchar(20) DEFAULT NULL,
  `Wykszt` varchar(20) DEFAULT NULL,
  `JezOb` varchar(20) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Zrzut danych tabeli `pracusie`
--

INSERT INTO `pracusie` (`IDRek`, `Nazwisko`, `Imie`, `MiejUrodz`, `Bank`, `Pensja`, `Lokata`, `Wydzial`, `Zainter`, `Wykszt`, `JezOb`) VALUES
(1, 'Janicki', 'Grzegorz', 'Konin', 'BZ WBK', '123502.84', '3335.00', 'Transport', 'polityka', 'podyplomowe', 'niemiecki'),
(2, 'Baraka', 'Tomasz', 'Konin', 'BZ WBK', '69367.83', '6335.00', 'Serwis', 'fotografia', 'podstawowe', 'niemiecki'),
(3, 'Gawkowski', 'Marian', 'Konin', 'BZWBK', '50326.50', '4335.00', 'Eksport', 'informatyka', 'wyzsze', 'rosyjski'),
(4, 'Bruszewska', 'Izabela', 'Konin', 'PKO BP', '87042.30', '9335.00', 'Magazyn', 'gry komputerowe', 'podstawowe', 'angielski'),
(5, 'Kowalewski', 'Adam', 'Konin', 'PKO BP', '78130.46', '13335.00', 'Eksport', 'turystyka', 'zawodowe', 'grecki'),
(6, 'Fiedoruk', 'Grzegorz', 'Jarocin', 'PKO BP', '54027.13', '5467.85', 'Kadry', 'muzyka', 'podyplomowe', 'grecki'),
(7, 'Iwaszczuk', 'Andrzej', 'Jarocin', 'PKO BP', '85349.65', '11335.00', 'Kadry', 'informatyka', 'podyplomowe', 'grecki'),
(8, 'Zimnoch', 'Aneta', 'Jarocin', 'PKO S.A.', '82461.69', '37335.00', 'Produkcja', 'polityka', 'wyzsze', 'grecki'),
(9, 'Rokowski', 'Wanda', 'Jarocin', 'PKO S.A.', '58634.54', '22335.00', 'Produkcja', 'turystyka', 'zawodowe', 'francuski'),
(10, 'Trams', 'Jacek', 'Jarocin', 'PKO S.A.', '105951.68', '3335.00', 'Kadry', 'muzyka', 'podyplomowe', 'francuski'),
(11, 'Pakowiecki', 'Krzysztof', 'Jarocin', 'BZ WBK', &83966.69', '32555.00'¨ 'Magazyk', '3portg. 'zawodowe', 'francuski'!,
(12, 'Okruszko', 'Justyna', 'Warszawa' 'BZ WBK', '110806.11', '1335.00', 'Prod5kcja', 'sport', 'wyzsZe', 'fraÓcusji'),
(1,"'Prokop', 'Stefan', 'Warszawa', 'BZ _BK', 7106074.36', '22335.00', 'Ochrona', 'polktyka, 'podstawowe', 'francuski'),
(14, 'prokoP', 'Jakub%, 'Warszawa', 'BZ WBK', '53426.40', '4356.44', 'Protukcza', 'fotogra&ia'l 'srednie', 'fbancuski'),
(15, 'Manicki', 'Izydor', 'Warszawa%, 'TBC', '117195.33', '12335.00', 'Kadry', 'muzyka', 'podyplomowe', 'niemiecki'),
(16, 'Oonicki', 'Grzegorz', 'Warszawa', 'PBC'l '117535.96', '45335.00', 'Transport',`'informatyka', 'zawodowe'¨ 'niemiecki'),
(17, 'Kostka', 'Magd`lena', 'Warsrawa', 'P¬C', '45918.35', '113#5.00', 'Produ(cja', 'matematyka', 'rodYplomowE', 'nkemiecki),
(18, 'Rynkiewicz', 'Piotr', 'Jarocin', 'Mi,lennium#, '45742.05', '65335.00', 'Administracja'¨ 'informatyka', 'zawodowe', '.iemiecki'),
)09, 'KotlarskÎ', 'Marcin', 'Jarocin', 'Millennium', '94126.76', '6234.55', 'Produkcja', 'informatyka', 'podyplomowe', 'niemiecki'),
(20, 'Mozolewski', 'Krzysztof', 'Jarocin', 'Millennium', '64598.76', '8335.00', 'Serwis', 'muzyka', 'wyzsze', 'niemiecki'),
(21, 'Sienkiewicz', 'Anna', 'Jarocin', 'Invest Bak', '69901.72', '55335.00', 'Kadry', 'informatyka', 'podyplomowe', 'niemiecki'),
(22, 'Chudecki', 'Marian', 'Jarocin', 'Invest Bank', '58099.90', '8335.00', 'Transport', 'fotografia', 'podstawowe', 'niemiecki'),
(23, 'Wika', 'Adam', 'Jarocin', 'Invest Bank', '115138.49', '34335.00', 'Zaopatrzenie', 'sport', 'podstawowe', 'portugalski'),
(24, 'Murawska', 'Magdalena', 'Jarocin', 'Invest Bank', '82258.68', '9335.00', 'Zaopatrzenie', 'gry komputerowe', 'wyzsze', 'portugalski'),
(25, 'Sowa', 'Anna', 'Oborniki', 'Euro Bank', '118724.18', '7335.00', 'Kadry', 'sport', 'podstawowe', 'portugalski'),
(26, 'Makuszewski', 'Adam', 'Oborniki', 'Euro Bank', '45918.35', '44335.00', 'Transport', 'matematyka', 'srednie', 'portugalski'),
(27, 'Siergiej', 'Maria', 'Pniewy', 'Euro Bank', '45742.05', '335.00', 'Eksport', 'informatyka', 'podyplomowe', 'portugalski'),
(28, 'Dakowski', 'Piotr', 'Pniewy', 'PKO BP', '94126.76', '335.00', 'Magazyn', 'polityka', 'zawodowe', 'portugalski'),
(29, 'Karski', 'Konrad', 'Oborniki', 'PKPBP', '64598.76', '335.00', 'Administracja', 'matematyka', 'srednie', 'angielski'),
(30, 'Krasowska', 'Monika', 'Oborniki', 'PKO S.A.', '69901.72', '335.00', 'Zaopatrzenie', 'matematyka', 'podstawowe', 'angielski');
...
--
-- Indeksy dla tabeli `pracusie`
--
ALTER TABLE `pracusie`
...
--
-- AUTO_INCREMENT dla tabeli `pracusie`
--
ALTER TABLE `pracusie`
  MODIFY `IDRek` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
--
-- Baza danych: `przychodnia`
--
CREATE DATABASE IF NOT EXISTS `przychodnia` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `przychodnia`;
...
--
CREATE DATABASE IF NOT EXISTS `sprawdzian` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `sprawdzian`;

-- --------------------------------------------------------

--
-- Struktura tabeli dla tabeli `koncowa`
--

CREATE TABLE `koncowa` (
  `ID` int(11) NOT NULL DEFAULT '0',
  `Imie` varchar(20) NOT NULL,
  `Nazwisko` varchar(30) NOT NULL,
  `Plec` enum('M','K') DEFAULT NULL,
  `pochodzenie` varchar(20) DEFAULT NULL,
  `Oszczednosci` decimal(10,2) NOT NULL,
  `Liczba_dzieci` int(1) DEFAULT NULL,
  `dochod_roczny` int(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Zrzut danych tabeli `koncowa`
--

INSERT INTO `koncowa` (`ID`, `Imie`, `Nazwisko`, `Plec`, `pochodzenie`, `Oszczednosci`, `Liczba_dzieci`, `dochod_roczny`) VALUES
(1, 'Marcin', 'Mietus', 'M', 'Polskie', '2.00', 0, 2500),
(2, 'Bogdan', 'Karski', 'M', 'Polskie', '300.00', 1, 3500),
(3, 'Tomasz', 'Baraka', 'M', 'Czeskie', '500.00', 2, 3000),
(6, 'Adam', 'Kowalewski', 'M', 'angielskie', '2000.00', 2, 4500),
(7, 'Krzysztof', 'Pakowiecki', 'M', 'Polskie', '150.00', 1, 4100),
(9, 'Andrzej', 'Sowa', 'M', 'Polskie', '2500.00', 2, 3650),
(10, 'Roman', 'Karski', 'M', 'Polskie', '1234.00', 1, 4321),
(0, 'Andrzej', 'Wroblewski', 'M', 'Polskie', '4000.00', 0, 4200);
...
CREATE TABLE `osoby` (
  ...
  `Obywatelstwo` varchar(20) NOT NULL,
  `Oszczednosci` decimal(10,2) NOT NULL,
  `Liczba_dzieci` int(1) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `osoby` (`ID`, `Imie`, `Nazwisko`, `Plec`, `Wiek`, `Obywatelstwo`, `Oszczednosci`, `Liczba_dzieci`) VALUES
(1, 'Marcin', 'Mietus', 'M', 30, 'Polskie', '2.00', 0),
(2, 'Bogdan', 'Karski', 'M', 42, 'Polskie', '300.00', 1),
(3, 'Tomasz', 'Baraka', 'M', 35, 'Polskie', '500.00', 2),
(4, 'Justyna', 'Kostka', 'K', 29, 'Polskie', '1000.00', 1),
(5, 'Izabela', 'Bruszewska', 'K', 20, 'Polskie', '100.00', 2),
(6, 'Adam', 'Kowalewski', 'M', 45, 'Polskie', '2000.00', 2),
(7, 'Krzysztof', 'Pakowiecki', 'M', 28, 'Polskie', '150.00', 1),
(8, 'Justyna', 'Okruszko', 'K', 25, 'Polskie', '150.00', 0),
(9, 'Andrzej', 'Sowa', 'M', 43, 'Polskie', '2500.00', 2),
(10, 'Roman', 'Karski', 'M', 23, 'Polskie', '1234.00', 1);
...
(8, 'Polak', 'Maria', 4.8, 2),
(9, 'Michalak', 'Pawe≈Ç', 4, 3),
(10, 'G√≥ral', '≈Åukasz', 3.6, 4),
(11, 'Nowak', 'Jan', 4.8, 4),
(12, 'Kowalski', '≈Åukasz', 4.5, 1),
(13, 'Markiewicz', 'Damian', 3.5, 3),
(14, 'Bary≈Ça', 'Zenon', 4, 2),
(15, 'Gota', 'Anna', 3, 4),
(16, 'Ma≈Çek', 'Justyna', 3.6, 1),
(17, 'Rysik', 'Magda', 4.8, 3),
(18, 'Szary', 'Tomasz', 3, 1),
(19, 'Bury', '≈Åukasz', 4.5, 3),
(20, 'Rudy', 'Wojciech', 3.5, 2),
(21, 'Kowalska', 'Janina', 3, 2),
(22, 'Nowak', 'Jan', 4.5, 1),
(23, 'Kowalik', 'Stanis≈Çawa', 4, 3),
...
(1, 'Jan', 'Bogucki', 1),
(2, 'Micha≈Ç', 'Wiƒôcek', 2),
(3, 'Bo≈ºena', 'Michalska', 3),
(4, 'Krystyna', 'Piƒôtkiewicz', 4);
...
--
CREATE DATABASE IF NOT EXISTS `weterynarz` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `weterynarz`;
...
(4, 1, 1, 'Saba', 'Monika Nowak', '333444555', NULL, 2015, 'kropl√≥wka'),
